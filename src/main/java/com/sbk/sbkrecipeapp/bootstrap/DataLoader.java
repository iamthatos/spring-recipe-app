package com.sbk.sbkrecipeapp.bootstrap;

import com.sbk.sbkrecipeapp.domain.*;
...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public DataLoader(CategoryRepository categoryRepository, RecipesRepository recipeRepository, 
